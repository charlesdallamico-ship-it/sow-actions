...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const mandatoryTypes = ["new_action", "action_changed", "overdue", "action_reproved", "deadline_approved", "action_reopened", "responsible_changed", "invite", "password_reset", "action_completed"];
