              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-xs text-slate-500 mt-0.5">
                    O provedor de e-mail (Resend) precisa ter a API key configurada nas variáveis de ambiente para que os envios sejam realizados. Se não configurado, as notificações serão registradas com status "configuration_required".
                  </div>
                </div>
